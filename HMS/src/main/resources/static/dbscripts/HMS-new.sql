...
INSERT INTO `users` VALUES (1,'Yash','Nemani','nemaniyh','nemaniyh','admin'),(2,'moulika','prasad','enduser','enduser','user'),(5,'Nick','Offerman','nickof','nickof','admin'),(6,'Jon','Hamm','DDraper','DDraper','user');
